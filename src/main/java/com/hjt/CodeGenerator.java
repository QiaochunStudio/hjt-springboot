...
//    private final static String APP_PROPERTY = "application.properties";
    ...
    private String entityTemplate = templatePath + "entity.java";

    private static String url = "jdbc:mysql://192.168.1.3:30306/hjt-springboot?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC&useSSL=false";
